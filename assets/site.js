window.HIDDEN_GEMS_CATALOG = {"new-releases": {"title": "New Releases", "subtitle": "Fresh premium drops added to the Hidden Gems vault. Unlock fast-moving releases before they rotate into the archive.", "count": "24 videos", "videos": [["nr-midnight-cut", "Midnight Cut", "A polished new visual drop with cinematic pacing and premium edits.", 300, "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?auto=format&fit=crop&w=1200&q=80"], ["nr-velocity-tape", "Velocity Tape", "A high-energy release built for replay value and sharp production.", 500, "https://images.unsplash.com/photo-1516280440614-37939bbacd81?auto=format&fit=crop&w=1200&q=80"], ["nr-diamond-hours", "Diamond Hours", "Premium late-night atmosphere with a larger-form presentation.", 700, "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?auto=format&fit=crop&w=1200&q=80"], ["nr-red-room-session", "Red Room Session", "A focused performance piece with intimate camera work.", 300, "https://images.unsplash.com/photo-1501386761578-eac5c94b800a?auto=format&fit=crop&w=1200&q=80"], ["nr-afterglow-run", "Afterglow Run", "A stylized release made for viewers who want premium replay content.", 500, "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=1200&q=80"], ["nr-vault-rare", "Vault Rare Drop", "A standout flagship release positioned as a top-tier unlock.", 700, "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?auto=format&fit=crop&w=1200&q=80"]]}, "most-popular": {"title": "Most Popular", "subtitle": "Top-performing videos across the platform, based on viewer demand and replay value.", "count": "18 videos", "videos": [["mp-gold-standard", "Gold Standard", "One of the strongest-performing videos in the Hidden Gems catalog.", 300, "https://images.unsplash.com/photo-1516280440614-37939bbacd81?auto=format&fit=crop&w=1200&q=80"], ["mp-summer-run", "Summer Run", "A replay-heavy favorite with standout crowd response.", 500, "https://images.unsplash.com/photo-1501386761578-eac5c94b800a?auto=format&fit=crop&w=1200&q=80"], ["mp-vault-classic", "Vault Classic", "A polished premium staple with long-term value.", 700, "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?auto=format&fit=crop&w=1200&q=80"], ["mp-shadow-room", "Shadow Room", "Strong visuals and a proven track record with buyers.", 300, "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=1200&q=80"], ["mp-motion-theory", "Motion Theory", "A high-performing catalog piece with premium structure.", 500, "https://images.unsplash.com/photo-1516280440614-37939bbacd81?auto=format&fit=crop&w=1200&q=80"], ["mp-royal-edit", "Royal Edit", "One of the most frequently revisited top-tier drops.", 700, "https://images.unsplash.com/photo-1501386761578-eac5c94b800a?auto=format&fit=crop&w=1200&q=80"]]}, "behind-the-scenes": {"title": "Behind the Scenes", "subtitle": "Process footage, setup moments, studio energy, and the making-of content that viewers usually never get to see.", "count": "12 videos", "videos": [["bts-studio-build", "Studio Build", "Watch the room come together before the cameras ever roll.", 300, "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=1200&q=80"], ["bts-shot-list", "Shot List Session", "A creator-side look at planning, pacing, and scene decisions.", 500, "https://images.unsplash.com/photo-1501386761578-eac5c94b800a?auto=format&fit=crop&w=1200&q=80"], ["bts-final-pass", "Final Pass", "The premium edit breakdown showing what changed before release.", 700, "https://images.unsplash.com/photo-1516280440614-37939bbacd81?auto=format&fit=crop&w=1200&q=80"], ["bts-lighting-test", "Lighting Test", "A closer look at framing, lighting, and production choices.", 300, "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?auto=format&fit=crop&w=1200&q=80"], ["bts-take-notes", "Take Notes", "A rawer session focused on adjustments and real-time decisions.", 500, "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=1200&q=80"], ["bts-vault-room", "Vault Room", "A bigger premium piece built for fans of the full process.", 700, "https://images.unsplash.com/photo-1501386761578-eac5c94b800a?auto=format&fit=crop&w=1200&q=80"]]}, "live-sessions": {"title": "Live Sessions", "subtitle": "Performance-driven content with live energy, room texture, and premium session-style presentation.", "count": "9 videos", "videos": [["ls-open-room", "Open Room", "A stripped-back live cut designed for fans of raw performance.", 300, "https://images.unsplash.com/photo-1501386761578-eac5c94b800a?auto=format&fit=crop&w=1200&q=80"], ["ls-night-session", "Night Session", "A high-demand live set with stronger production and pacing.", 500, "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?auto=format&fit=crop&w=1200&q=80"], ["ls-front-row", "Front Row", "Premium front-of-room energy with elevated visual treatment.", 700, "https://images.unsplash.com/photo-1516280440614-37939bbacd81?auto=format&fit=crop&w=1200&q=80"], ["ls-control-room", "Control Room", "A live-feel session with a more intimate frame and tone.", 300, "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=1200&q=80"], ["ls-vault-set", "Vault Set", "A strong medium-tier live unlock built for repeat viewers.", 500, "https://images.unsplash.com/photo-1501386761578-eac5c94b800a?auto=format&fit=crop&w=1200&q=80"], ["ls-stage-lights", "Stage Lights", "A headline live performance positioned as a top-tier unlock.", 700, "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?auto=format&fit=crop&w=1200&q=80"]]}, "short-films": {"title": "Short Films", "subtitle": "Story-driven premium visuals with cinematic structure, sharper pacing, and high replay value.", "count": "15 videos", "videos": [["sf-silver-city", "Silver City", "A concise story-led visual with moody worldbuilding.", 300, "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=1200&q=80"], ["sf-burn-slow", "Burn Slow", "A stronger narrative cut with layered premium presentation.", 500, "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?auto=format&fit=crop&w=1200&q=80"], ["sf-crown-scene", "Crown Scene", "A flagship cinematic piece built as a premium top-tier unlock.", 700, "https://images.unsplash.com/photo-1516280440614-37939bbacd81?auto=format&fit=crop&w=1200&q=80"], ["sf-window-seat", "Window Seat", "A softer visual piece with story-first framing and motion.", 300, "https://images.unsplash.com/photo-1501386761578-eac5c94b800a?auto=format&fit=crop&w=1200&q=80"], ["sf-last-call", "Last Call", "A mid-tier short film with elevated pacing and edit rhythm.", 500, "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=1200&q=80"], ["sf-noir-room", "Noir Room", "One of the most premium cinematic drops in the archive.", 700, "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?auto=format&fit=crop&w=1200&q=80"]]}, "creator-picks": {"title": "Creator Picks", "subtitle": "Hand-selected standouts that represent the strongest direction, quality, and replay value in the vault.", "count": "10 videos", "videos": [["cp-first-impression", "First Impression", "A lean, confident pick that defines the Hidden Gems tone.", 300, "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?auto=format&fit=crop&w=1200&q=80"], ["cp-top-shelf", "Top Shelf", "A medium-tier favorite chosen for polish and replay factor.", 500, "https://images.unsplash.com/photo-1516280440614-37939bbacd81?auto=format&fit=crop&w=1200&q=80"], ["cp-master-cut", "Master Cut", "A premium creator-selected feature built for collectors.", 700, "https://images.unsplash.com/photo-1501386761578-eac5c94b800a?auto=format&fit=crop&w=1200&q=80"], ["cp-skyline-note", "Skyline Note", "A personal standout with clean execution and mood.", 300, "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=1200&q=80"], ["cp-gridline", "Gridline", "A strong medium-tier selection with refined direction.", 500, "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?auto=format&fit=crop&w=1200&q=80"], ["cp-signature-room", "Signature Room", "A flagship creator pick positioned as a top-tier unlock.", 700, "https://images.unsplash.com/photo-1516280440614-37939bbacd81?auto=format&fit=crop&w=1200&q=80"]]}, "vip-exclusives": {"title": "VIP Exclusives", "subtitle": "Members-only premium vault content. These titles stay locked unless VIP access is active on the account.", "count": "Members only", "vip": true, "videos": [["vip-vault-access-one", "Vault Access One", "A members-only flagship release reserved for VIP accounts.", 0, "https://images.unsplash.com/photo-1501386761578-eac5c94b800a?auto=format&fit=crop&w=1200&q=80"], ["vip-vault-access-two", "Vault Access Two", "A premium vault unlock with VIP-only watch and download rights.", 0, "https://images.unsplash.com/photo-1516280440614-37939bbacd81?auto=format&fit=crop&w=1200&q=80"], ["vip-vault-access-three", "Vault Access Three", "A top-shelf exclusive built to reward VIP members only.", 0, "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?auto=format&fit=crop&w=1200&q=80"]]}};


window.HiddenGemsApp = (() => {
  const APP_CONFIG = window.GEMS_HIDDEN_CONFIG || {};
  const AUTH_CONFIG = APP_CONFIG.auth || {};
  const SUPPORT_EMAIL = APP_CONFIG.supportEmail || 'support@YOUR-DOMAIN.com';
  ...
  const VIDEO_BUCKET = 'hg-videos';
  let liveVideoCache = [];
  let liveVideoCacheLoaded = false;
  ...
  function normalizeVideoItem(item = {}, fallback = {}) {
    ...
    return {
      ...
      videoStoragePath: String(base.videoStoragePath || base.video_storage_path || '').trim(),
      isPublished: base.isPublished !== false && base.is_published !== false,
      isCustom: !!base.isCustom
    };
  }

  function getVideoSource(video) {
    if (video?.videoStoragePath) return { type: 'storage', value: video.videoStoragePath, mimeType: video.videoMimeType || '', fileName: video.videoFileName || '' };
  ...
  function mapDbRowToVideo(row = {}) {
    return normalizeVideoItem({
      ...
      categorySlug: row.category || 'creator-picks',
      categoryTitle: titleFromSlug(row.category || 'creator-picks'),
      category: titleFromSlug(row.category || 'creator-picks'),
      access: row.access_type || 'guest',
      points: 0,
  ...
  async function refreshLiveVideoCache(force = false) {
    const supabase = getSupabaseClient();
    if (!supabase) return liveVideoCache;
    if (liveVideoCacheLoaded && !force) return liveVideoCache;
    try {
      const result = await supabase
        .from(VIDEO_TABLE)
        .select('id,title,description,category,access_type,thumbnail_url,video_url,video_storage_path,video_file_name,video_mime_type,is_published,created_at')
        .order('created_at', { ascending: false });
      if (result.error) throw result.error;
      liveVideoCache = (result.data || []).map(mapDbRowToVideo);
      liveVideoCacheLoaded = true;
      return liveVideoCache;
    } catch (error) {
      console.error('Hidden Gems live video sync failed', error);
      return liveVideoCache;
    }
  }

  function getLiveVideosSnapshot() {
    return Array.isArray(liveVideoCache) ? liveVideoCache.slice() : [];
  }

  async function uploadVideoFileToSupabase(file, videoId) {
    const supabase = getSupabaseClient();
    if (!supabase || !file || !videoId) return null;
    const safeName = String(file.name || 'video.mp4').replace(/[^a-zA-Z0-9._-]/g, '-');
    const path = `videos/${videoId}/${Date.now()}-${safeName}`;
    const result = await supabase.storage.from(VIDEO_BUCKET).upload(path, file, { upsert: true, contentType: file.type || 'video/mp4' });
    if (result.error) throw result.error;
    return { path, fileName: file.name || safeName, mimeType: file.type || 'video/mp4' };
  }

  async function removeVideoFileFromSupabase(path) {
    const supabase = getSupabaseClient();
    if (!supabase || !path) return;
    try { await supabase.storage.from(VIDEO_BUCKET).remove([path]); } catch (error) {}
  }

  async function getSignedVideoUrl(path) {
    const supabase = getSupabaseClient();
    if (!supabase || !path) return '';
    const result = await supabase.storage.from(VIDEO_BUCKET).createSignedUrl(path, 60 * 30);
    if (result.error) throw result.error;
  ...
  function allCategories() {
    ...
    const liveVideos = getLiveVideosSnapshot().filter((video) => video.isPublished !== false);
    const liveById = new Map(liveVideos.map((video) => [video.id, video]));
    ...
    Object.entries(catalog).forEach(([slug, category]) => {
      ...
      category.videos = (category.videos || [])
        ...
        .map((video) => {
          ...
          const override = live.id ? live : (videoOverrides[id] || {});
          seenIds.add(id);
          return normalizeVideoItem({
            id,
            ...
            videoStoragePath: override.videoStoragePath || '',
            sourceType: override.videoStoragePath ? 'storage' : ((override.videoFile || override.videoFileRef) ? 'file' : (override.sourceType || 'link')),
    ...
    for (const rawVideo of liveVideos) {
      const video = normalizeVideoItem({ ...rawVideo, isCustom: true });
      if (seenIds.has(video.id)) continue;
      const slug = video.categorySlug || 'creator-picks';
      if (!catalog[slug]) {
        catalog[slug] = { title: video.categoryTitle || titleFromSlug(slug), subtitle: 'Custom admin-managed category.', count: 'Custom', slug, access: video.access, videos: [] };
      }
    ...
    for (const rawVideo of storage.getCustomVideos()) {
      ...
      if (seenIds.has(video.id) || liveById.has(video.id)) continue;
      const slug = video.categorySlug || 'creator-picks';
      if (!catalog[slug]) {
        catalog[slug] = { title: video.categoryTitle || titleFromSlug(slug), subtitle: 'Custom admin-managed category.', count: 'Custom', slug, access: video.access, videos: [] };
      }
    ...
    Object.values(catalog).forEach((category) => {
      ...
      category.access = category.vip ? 'vip' : 'guest';
      category.videos = (category.videos || []).filter((video) => video.isPublished !== false).map((video) => ({ ...video, category: video.category || category.title, categoryTitle: video.categoryTitle || category.title }));
    });
    return catalog;
  }
  ...
  function allVideos() {
    ...
    return Object.entries(catalog).flatMap(([slug, category]) => (category.videos || []).map((video) => ({
  ...
  function getCategory(slug) { const catalog = allCategories(); return catalog[slug] ? { ...catalog[slug], slug, videos: allVideos().filter((video) => video.categorySlug === slug) } : null; }
      ...
      <header class="sticky top-0 z-50 border-b border-white/10 bg-black/75 backdrop-blur-xl">
        <div class="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <nav class="hidden gap-6 text-sm text-neutral-300 md:flex">
            ...
            <a data-nav-link="my-library" href="my-library.html" class="transition hover:text-pink-300">Library</a>
          </nav>
  ...
  function videoPrimaryAction(state, video) {
    ...
    return { text: `Unlock for ${video.points} pts`, href: '#', kind: 'buy' };
  }
  ...
  function renderCategoryPage(slug) {
    ...
    bindCommonUi();
    const mount = async () => {
      await refreshLiveVideoCache(true);
  ...
  function renderVideoPage() {
    ...
    const mount = async () => {
      ...
      const heroImg = document.getElementById('video-hero-image');
      if (heroImg) { heroImg.src = video.image || ''; heroImg.alt = video.title || ''; }
      document.getElementById('video-category-label').textContent = video.category || '';
      document.getElementById('video-title-heading').textContent = video.title || '';
      document.getElementById('video-detail-category').textContent = video.category || '';
      document.getElementById('video-detail-tier').textContent = video.access === 'vip' ? 'VIP / Admin' : `${video.points} pts or above`;
      const state = await getState();
      ...
      const unlocked = state.role === 'admin' || state.role === 'vip' || storage.isUnlocked(video.id);
      if (!accessible) {
      ...
      } else if (!unlocked && video.access === 'guest') {
        banner.innerHTML = `<p class="text-sm uppercase tracking-[0.2em] text-pink-300">Unlock Needed</p><h3 class="mt-2 text-2xl font-bold text-white">Unlock this title for ${video.points} points</h3><p class="mt-3 text-neutral-300">Your wallet currently has <span class="font-semibold text-white">${state.localPoints}</span> points.</p>`;
        player.innerHTML = '<p class="text-neutral-400">Unlock this title to open the video destination.</p>';
        actionButton.textContent = `Unlock for ${video.points} pts`; actionButton.href = '#'; actionButton.onclick = (event) => { event.preventDefault(); buyVideo(video); setTimeout(mount, 300); };
      } else {
        const source = getVideoSource(video);
        banner.innerHTML = `<p class="text-sm uppercase tracking-[0.2em] text-emerald-300">Access Granted</p><h3 class="mt-2 text-2xl font-bold text-white">You can open this video</h3><p class="mt-3 text-neutral-300">${source.type === 'storage' || source.type === 'file' ? 'Your video file is attached below.' : source.type === 'link' ? 'Your custom video link is attached below.' : 'No video source has been added yet.'}</p>`;
        if (source.type === 'storage') {
          try {
            const signedUrl = await getSignedVideoUrl(source.value);
            player.innerHTML = signedUrl ? `<div class="space-y-4"><video controls playsinline preload="metadata" class="w-full rounded-2xl border border-white/10 bg-black"><source src="${escapeHtml(signedUrl)}" type="${escapeHtml(source.mimeType || 'video/mp4')}" />Your browser does not support embedded video playback for this file.</video>${source.fileName ? `<p class="text-sm text-neutral-500 break-all">${escapeHtml(source.fileName)}</p>` : ''}</div>` : '<p class="text-neutral-400">Uploaded video file could not be loaded.</p>';
          } catch (error) {
            console.error(error);
            player.innerHTML = '<p class="text-neutral-400">Uploaded video file could not be loaded.</p>';
          }
        } else if (source.type === 'file') {
          const blob = source.value ? null : await getVideoBlob(source.ref);
          const objectUrl = source.value || (blob ? URL.createObjectURL(blob) : '');
          player.innerHTML = objectUrl ? `<div class="space-y-4"><video controls playsinline preload="metadata" class="w-full rounded-2xl border border-white/10 bg-black"><source src="${escapeHtml(objectUrl)}" type="${escapeHtml(source.mimeType || 'video/mp4')}" />Your browser does not support embedded video playback for this file.</video>${source.fileName ? `<p class="text-sm text-neutral-500 break-all">${escapeHtml(source.fileName)}</p>` : ''}</div>` : '<p class="text-neutral-400">Uploaded video file could not be loaded in this browser.</p>';
        } else if (source.type === 'link') {
          player.innerHTML = `<p class="text-neutral-300">Video destination:</p><a class="mt-4 inline-flex rounded-2xl bg-pink-500 px-5 py-3 font-semibold text-white" href="${escapeHtml(source.value)}" target="_blank" rel="noreferrer">Open Video Link</a><p class="mt-3 break-all text-xs text-neutral-500">${escapeHtml(source.value)}</p>`;
        } else {
          player.innerHTML = '<p class="text-neutral-400">No video source has been added yet.</p>';
        }
        actionButton.textContent = source.type === 'link' ? 'Open Link' : 'Ready to watch';
        actionButton.href = source.type === 'link' ? source.value : '#video-player-shell';
  ...
  function renderLibraryPage() {
    ...
    const mount = async () => {
      await refreshLiveVideoCache(true);
      const video = getVideo(videoId); if (!video) { window.location.href = 'index.html'; return; }
      const backLink = document.querySelector('main a.inline-flex'); if (backLink) backLink.href = `${video.categorySlug}.html`;
      const heroImg = document.querySelector('section img'); if (heroImg) { heroImg.src = video.image || ''; heroImg.alt = video.title || ''; }
      document.querySelector('section .text-xs.uppercase') && (document.querySelector('section .text-xs.uppercase').textContent = video.category || '');
      document.querySelector('section h1') && (document.querySelector('section h1').textContent = video.title || '');
      const detailBlocks = document.querySelectorAll('aside .rounded-2xl.bg-neutral-900\/80 p');
      const state = await getState();
  ...
  function renderAdminPage() {
    ...
    const mount = async () => {
      ...
      const setThumbnailPreview = (value) => {
        ...
        const preview = thumbnailData || fallbackValue;
        if (preview) {
      ...
      const updateSourceNote = () => {
        ...
        if (videoStoragePath) sourceNote.innerHTML = `<span class="font-semibold text-emerald-300">Using shared uploaded file</span>${videoFileName ? ` · ${escapeHtml(videoFileName)}` : ''}`;
        else if (videoData) sourceNote.innerHTML = `<span class="font-semibold text-emerald-300">Using uploaded file</span>${videoFileName ? ` · ${escapeHtml(videoFileName)}` : ''}`;
      ...
      const renderVideoList = () => {
        ...
        document.querySelectorAll('[data-edit-video]').forEach((button) => button.addEventListener('click', () => {
          const video = getVideo(button.dataset.editVideo);
        ...
        document.querySelectorAll('[data-delete-video]').forEach((button) => button.addEventListener('click', async () => {
          ...
          const liveTarget = getLiveVideosSnapshot().find((item) => item.id === id) || null;
          ...
          const supabase = getSupabaseClient();
          if (liveTarget && supabase) {
            if (liveTarget.videoStoragePath) await removeVideoFileFromSupabase(liveTarget.videoStoragePath);
            try { await supabase.from(VIDEO_TABLE).delete().eq('id', id); } catch (error) { console.error(error); }
            await refreshLiveVideoCache(true);
          } else if (custom.some((item) => item.id === id)) {
      ...
      form.elements.thumbnailFile?.addEventListener('change', async (event) => {
        ...
        try { setThumbnailPreview(await readFileAsDataUrl(file)); } catch (error) { toast('Thumbnail upload failed.', 'error'); }
      });
      form.elements.image.addEventListener('input', () => setThumbnailPreview(thumbnailData || String(form.elements.image.value || '').trim()));
      ...
      form.addEventListener('submit', async (event) => {
        ...
        const imageValue = thumbnailData || String(data.get('image') || '').trim();
        ...
        try {
          const supabase = getSupabaseClient();
          const currentLive = getLiveVideosSnapshot().find((video) => video.id === id) || null;
          const selectedFile = form.elements.videoFile?.files?.[0] || null;

          if (supabase) {
            const user = await getSessionUser();
            let nextStoragePath = currentLive?.videoStoragePath || '';
            let nextFileName = currentLive?.videoFileName || '';
            let nextMimeType = currentLive?.videoMimeType || '';

            if (selectedFile) {
              if (currentLive?.videoStoragePath) await removeVideoFileFromSupabase(currentLive.videoStoragePath);
              const uploaded = await uploadVideoFileToSupabase(selectedFile, id);
            ...
            const payload = {
              ...
              video_storage_path: nextStoragePath || null,
              video_file_name: nextFileName || null,
              video_mime_type: nextMimeType || null,
              is_published: true,
              sort_order: 0,
            ...
            if (selectedFile) {
              ...
              await saveVideoBlob(blobRef, selectedFile);
          ...
          console.error(error);
          toast('Video could not be saved to Supabase. Check your storage/table policies and try again.', 'error');
        }
      });
  ...
  function initHomePage() { const syncHome = async () => { await refreshLiveVideoCache(true); updateHomeStateUi(await getState()); }; syncHome(); window.addEventListener('hg:state-changed', syncHome); }
