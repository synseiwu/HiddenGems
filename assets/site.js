...
window.HiddenGemsApp = (() => {
  ...
  function injectThemeStyles() {
    ...
    style.textContent = `
      ...
      html[data-hg-theme="light"] .from-pink-500\/10, html[data-hg-theme="light"] .via-fuchsia-500\/10 { --tw-gradient-from: rgba(236,72,153,.08) var(--tw-gradient-from-position) !important; --tw-gradient-to: rgba(236,72,153,0) var(--tw-gradient-to-position) !important; --tw-gradient-stops: var(--tw-gradient-from), rgba(217,70,239,.06) var(--tw-gradient-via-position), var(--tw-gradient-to) !important; }
      ...
      html[data-hg-theme="midnight"] .border-pink-400\/20, html[data-hg-theme="midnight"] .border-pink-400\/30 { border-color: rgba(96,165,250,.28) !important; }
      html[data-hg-theme="midnight"] .from-pink-500\/10, html[data-hg-theme="midnight"] .via-fuchsia-500\/10 { --tw-gradient-from: rgba(37,99,235,.14) var(--tw-gradient-from-position) !important; --tw-gradient-to: rgba(37,99,235,0) var(--tw-gradient-to-position) !important; --tw-gradient-stops: var(--tw-gradient-from), rgba(96,165,250,.10) var(--tw-gradient-via-position), var(--tw-gradient-to) !important; }
