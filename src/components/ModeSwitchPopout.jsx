...
export default function ModeSwitchPopout() {
  ...
  // Hard rule: this variant switch belongs on the About page only.
  // It should never appear on Home, AI Studio chat, Points, Account, Admin, etc.
  ...
  useEffect(() => {
    ...
    function checkScroll() {
      ...
      // About page only: fade in once user scrolls or reaches lower part of the page.
  ...
  async function switchMode() {
    ...
    try {
      if (isAdmin) {
        // Admins switch the real global mode.
